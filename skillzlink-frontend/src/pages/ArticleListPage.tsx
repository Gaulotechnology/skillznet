              ...
              <div className="col-12 col-sm-12 col-md-12 col-lg-12 float-left">
                <div className="wt-articletabshold wt-articlelist">
                  ...
                  <div className="tab-content wt-haslayout">
                    ...
                    {/* Other tabs are intentionally kept minimal or same structure for now, but typically these are handled dynamically in React. I'll just include one empty tab structure for brevity, as they repeat. */}
                    <div className="wt-contentarticle tab-pane fade" id="business">
                      <div className="row">
                        {/* Repeat articles or fetch dynamically */}
                      </div>
                    </div>
                    <div className="wt-contentarticle tab-pane fade" id="trading">
                      <div className="row"></div>
                    </div>
                    <div className="wt-contentarticle tab-pane fade" id="economics">
                      <div className="row"></div>
                    </div>
                    <div className="wt-contentarticle tab-pane fade" id="marketing">
                      <div className="row"></div>
                    </div>
