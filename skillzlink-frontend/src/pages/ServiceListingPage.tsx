            ...
            <div className="col-xs-12 col-sm-12 col-md-8 push-md-2 col-lg-6 push-lg-3">
              <div className="wt-innerbannercontent">
                ...
                <ol className="wt-breadcrumb">
                  <li><a href="/">Home</a></li>
                  <li className="wt-active">Service</li>
                </ol>
              </div>
            </div>
          </div>
                            ...
                            <fieldset>
                              <div className="wt-checkboxholder">
                                <span className="wt-radio">
                                  ...
                                  <label htmlFor="project"> Any Service Type</label>
                                </span>
                                <span className="wt-radio">
                                  <input id="hourly" type="radio" name="description" value="company" />
                                  <label htmlFor="hourly"> Hourly Based Service</label>
                                </span>
                                <span className="wt-radio">
                                  <input id="fixed" type="radio" name="description" value="company" />
                                  <label htmlFor="fixed"> Fixed Price Service</label>
                                </span>
                              </div>
                            </fieldset>
                          </form>
                            ...
                            <fieldset>
                              <div className="wt-checkboxholder wt-verticalscrollbar">
                                <span className="wt-checkbox">
                                  ...
                                  <label htmlFor="wt-description"> <img src="/images/flag/img-04.png" alt="img description" /> Harare</label>
                                </span>
                                <span className="wt-checkbox">
                                  <input id="us" type="checkbox" name="description" value="company" />
                                  <label htmlFor="us"> <img src="/images/flag/img-04.png" alt="img description" /> Bulawayo</label>
                                </span>
                              </div>
                            </fieldset>
                          </form>
                  ...
                  <div className="col-xs-12 col-sm-12 col-md-7 col-lg-7 col-xl-8 float-left">
                    <div className="wt-userlistingholder wt-haslayout">
                      <div className="wt-userlistingtitle">
                        <span>01 - 48 of 124 results for <em>"Plumbing Services"</em></span>
                      </div>
                      <div className="wt-filterholder">
                        <ul className="wt-filtertag">
                          ...
                          <li className="alert alert-dismissable fade in">
                            <a href="#!"><i className="fa fa-times close" data-dismiss="alert" aria-label="close"></i> <span>Electrical</span></a>
                          </li>
                        </ul>
                      </div>
                        ...
                        <div className="wt-userlistingcontent">
                          <div className="wt-contenthead">
                            <div className="wt-title">
                              <a href="/user-single"><i className="fa fa-check-circle"></i> Tinashe Plumbing Solutions</a>
                              <h2>I need a plumber for pipe installation</h2>
                            </div>
                          ...
                          <div className="wt-viewjobholder">
                            <ul>
                              ...
                              <li><span><em><img src="/images/flag/img-04.png" alt="img description" /></em>Mutare</span></li>
                              ...
                              <li className="wt-btnarea"><Link to="/service/gy3yV2Vm5u" className="wt-btn">View Service</Link></li>
                            </ul>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="wt-userlistinghold wt-featured wt-userlistingholdvtwo">
                        ...
                        <div className="wt-userlistingcontent">
                          <div className="wt-contenthead">
                            <div className="wt-title">
                              <a href="/user-single"><i className="fa fa-check-circle"></i> Chipo Electricals</a>
                              <h2>Home electrical wiring and fault finding</h2>
                            </div>
                            <div className="wt-description">
                              <p>Nisi ut aliquip ex ea commodo consequat duis aute irure dolor in reprehenderit inati voluptate velit esse cillum dolore eutates fugiat nulla pariatur sunt in culpa asequi officia deserunt mollit anim id est laborum ut perspiciatis...</p>
                            </div>
                          ...
                          <div className="wt-viewjobholder">
                            <ul>
                              <li><span><i className="fa fa-dollar-sign wt-viewjobdollar"></i>Professional</span></li>
                              <li><span><em><img src="/images/flag/img-04.png" alt="img description" /></em>Bulawayo</span></li>
                              ...
                              <li><span><i className="fa fa-tag wt-viewjobtag"></i>Service ID: 5aUQgM2ZbW</span></li>
                              <li><a href="#!" className="wt-clicklike"><i className="fa fa-heart"></i> Click to Save</a></li>
                              <li className="wt-btnarea"><Link to="/service/5aUQgM2ZbW" className="wt-btn">View Service</Link></li>
                            </ul>
                          </div>
                        </div>
                      </div>
