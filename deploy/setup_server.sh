...
echo ""
echo "Next steps:"
echo "  1. Clone the repo: git clone https://github.com/Gaulotechnology/skillznet.git /opt/skillzlink"
echo "  2. Create deploy/.env from deploy/.env.example"
echo "  3. Copy LHC settings: cp skillzlink-backend/public/lhc/settings/settings.ini.dist.php skillzlink-backend/public/lhc/settings/settings.ini.php"
echo "     Then edit the DB credentials in that file"
echo "  4. Run: bash deploy/launch.sh"
